...
const countriesEndsByia = countries.filter((country) => country.endsWith('i'))
...
const result_of_reduce = numbers9.reduce((acc, element) => acc + element, 0)//-->el cero es el valor inicial del acumulador
